...
const toMainScreenButton = gameTwoImgScreen.querySelector(`.back`);
...
const onGameContentFormInputsChange = () => {
  changeGameScreen(gameOneImgScreen, [radioInputsFirstQuestion, radioInputsSecondQuestion]);
};
...
export default gameTwoImgScreen;
